...
def run(
        ...
        project=os.path.join(settings.BASE_DIR,'static/results'), # Project directory save model
    ...
    path_to_replace = os.path.join(settings.BASE_DIR,'media/images/')
    replace_path = name_file.replace(path_to_replace, '')
    path_save_image = str(save_dir) + '/'+str(replace_path)
